...
# -*- -*- -*- Begin included fragment: doc/secret_add -*- -*- -*-





# TODO: FILL OUT THIS DOC FILE!!!!
# DO NOT PR WIHTOUT THIS DOC FILE!!!!
...
# -*- -*- -*- End included fragment: doc/secret_add -*- -*- -*-
...
# -*- -*- -*- Begin included fragment: class/oc_secret_add.py -*- -*- -*-
...
# -*- -*- -*- End included fragment: class/oc_secret_add.py -*- -*- -*-

# -*- -*- -*- Begin included fragment: ansible/oc_secret_add.py -*- -*- -*-
...
# -*- -*- -*- End included fragment: ansible/oc_secret_add.py -*- -*- -*-
